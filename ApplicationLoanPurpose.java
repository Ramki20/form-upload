...
public class ApplicationLoanPurpose extends AuditedEntity {
	...
	@Builder.Default
	private Set<SupportingDocumentReferenceLoanPurpose> supportingDocumentReferenceSet = new HashSet<>();

	public void createSupportingDocument(SupportingDocument supportingDocument) {

		supportingDocumentReferenceSet.add(SupportingDocumentReferenceLoanPurpose.builder()
	...
	public Set<Integer> getAllSupportingDocumentIdentifiers() {
		...
		return this.supportingDocumentReferenceSet.stream()
				.map(SupportingDocumentReferenceLoanPurpose::getSupportingDocumentIdentifier)
