...
public class FBPProxyBS_UT_Mockito extends DLSExternalCommonTestMockBase {
    ...
    public void testRetrieveCreditActionForCustomer_ValidationException() throws Exception {
        ...
        try {
            ...
            assertTrue("Exception message should contain validation info", 
    ...
    public void testRetrieveCreditActionForCustomer_DaoThrowsRuntimeException() throws Exception {
        ...
        try {
            ...
            assertTrue("Exception message should contain runtime error info", 
    ...
    public void testRetrieveDALRDataForCustomer_DaoThrowsRuntimeException() throws Exception {
        ...
        try {
            ...
            assertTrue("Exception message should contain network error info", 
                      ex.getMessage().contains("Network timeout"));
        }
    }
...
}PlanBO> createFarmBusinessPlanBOCollection() {
        List<FarmBusinessPlanBO> list = new ArrayList<>();
    ...
    private Collection<FarmBusiness