...
@PrepareForTest({NPSConnector.class, AgencyToken.class, NPSConnectorFactory.class, CancelRequestConnectorContract.class, 
	RetrievePaymentStatusConnectorContract.class, RetrievePaymentStatusByURIConnectorContract.class,
	RetrieveOverpaymentStatusByURIConnectorContract.class})
...
public class DisbursementBSMock_UT extends DLSExternalCommonTestMockBase
{
	...
	public void testCreateAPaymentRequest() throws Exception
	{
		...
		NPSConnector npsConnectorMock = PowerMockito.mock(NPSConnector.class);
		PowerMockito.mockStatic(NPSConnectorFactory.class);
		PowerMockito.doReturn(npsConnectorMock).when(NPSConnectorFactory.class, "getConnector", token);
		
		PaymentConnectorResponse response = populatePaymentConnectorResponse();
		Mockito.when(npsConnectorMock.processPayment(Mockito.any(PaymentRequestConnectorContract.class))).thenReturn(response);
		
		//IDisbursementBS disbursementBS = ServiceAgentFacade.getInstance().getDisbursementBusinessService();
	...
	public void testCreateAPaymentRequest_NPSConnectorException() throws Exception
	{
		...
		PowerMockito.mockStatic(NPSConnectorFactory.class);
		PowerMockito.doReturn(npsConnectorMock).when(NPSConnectorFactory.class, "getConnector", token);
		Mockito.when(npsConnectorMock.processPayment(Mockito.any(PaymentRequestConnectorContract.class))).thenThrow(new NPSConnectorException("Test NPSConnectorException.."));
	...
	public void testCancelAPaymentRequest() throws Exception
	{
		...
		PaymentConnectorResponse response = populatePaymentConnectorResponse();
		Mockito.when(npsConnectorMock.cancelPayment(Mockito.any(CancelRequestConnectorContract.class))).thenReturn(response);
	...
	public void testCancelAPaymentRequest_WithNPSConnectorException() throws Exception
	{
		...
		PowerMockito.mockStatic(NPSConnectorFactory.class);
		PowerMockito.doReturn(npsConnectorMock).when(NPSConnectorFactory.class, "getConnector", token);
		Mockito.when(npsConnectorMock.cancelPayment(Mockito.any(CancelRequestConnectorContract.class))).thenThrow(new NPSConnectorException("Test NPSConnectorException..."));
	...
	public void testRetrieveFinancialEligibility() throws Exception
	{
		...
		Mockito.when(npsConnectorMock.retrieveEligibilityInformation(Mockito.any(FinancialEligibilityConnectorContract.class))).thenReturn(response);
	...
	public void testRetrieveFinancialEligibility_ResponseNPSConnectorException() throws Exception
	{
		...
		Mockito.when(npsConnectorMock.retrieveEligibilityInformation(Mockito.any(FinancialEligibilityConnectorContract.class))).thenThrow(new NPSConnectorException("Test NPSConnectorException..."));
	...
	public void testRetrievePaymentRequestByConfirmationNumber() throws Exception
	{
		...
		PaymentConnectorResponse response = populatePaymentConnectorResponse();
		Mockito.when(npsConnectorMock.retrievePaymentStatus(Mockito.any(RetrievePaymentStatusConnectorContract.class))).thenReturn(response);
	...
	public void testRetrievePaymentRequestByConfirmationNumber_NPSConnectorException() throws Exception
	{
		...
		PowerMockito.mockStatic(NPSConnectorFactory.class);
		PowerMockito.doReturn(npsConnectorMock).when(NPSConnectorFactory.class, "getConnector", token);
		Mockito.when(npsConnectorMock.retrievePaymentStatus(Mockito.any(RetrievePaymentStatusConnectorContract.class))).thenThrow(new NPSConnectorException("Test NPSConnectorException.."));
	...
	public void testRetrievePaymentRequestByURI() throws Exception
	{
		...
		PaymentConnectorResponse response = populatePaymentConnectorResponse();
		Mockito.when(npsConnectorMock.retrievePaymentStatusByURI(Mockito.any(RetrievePaymentStatusByURIConnectorContract.class))).thenReturn(response);
	...
	public void testRetrievePaymentRequestByURI_WithNPSConnectorException() throws Exception
	{
		...
		PowerMockito.mockStatic(NPSConnectorFactory.class);
		PowerMockito.doReturn(npsConnectorMock).when(NPSConnectorFactory.class, "getConnector", token);
		Mockito.when(npsConnectorMock.retrievePaymentStatusByURI(Mockito.any(RetrievePaymentStatusByURIConnectorContract.class))).thenThrow(new NPSConnectorException("Test NPSConnectorException.."));
	...
	public void testretrieveOverpaymentStatusByURI() throws Exception
	{
		...
		Mockito.when(npsConnectorMock.retrieveOverpaymentStatusByURI(Mockito.any(RetrieveOverpaymentStatusByURIConnectorContract.class))).thenReturn(response);
	...
	public void testretrieveOverpaymentStatusByURI_WithNPSConnectorException() throws Exception
	{
		...
		PowerMockito.mockStatic(NPSConnectorFactory.class);
		PowerMockito.doReturn(npsConnectorMock).when(NPSConnectorFactory.class, "getConnector", token);
		Mockito.when(npsConnectorMock.retrieveOverpaymentStatusByURI(Mockito.any(RetrieveOverpaymentStatusByURIConnectorContract.class))).thenThrow(new NPSConnectorException("Test NPSConnectorException.."));
	...
	public void testIsHealthy_InvalidResponse() throws Exception
	{
		...
		PowerMockito.mockStatic(NPSConnectorFactory.class);
		PowerMockito.doReturn(npsConnectorMock).when(NPSConnectorFactory.class, "getConnector", token);
		Mockito.when(npsConnectorMock.checkHealth(Mockito.any(CheckHealthConnectorContract.class)))
		.thenReturn(null);
